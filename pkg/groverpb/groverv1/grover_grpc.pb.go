...
const (
	HeartBeat_Pulse_FullMethodName = "/grover.v1.HeartBeat/Pulse"
)
...
func (c *heartBeatClient) Pulse(ctx context.Context, in *PulseRequest, opts ...grpc.CallOption) (*PulseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PulseResponse)
	err := c.cc.Invoke(ctx, HeartBeat_Pulse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHeartBeatServer) Pulse(context.Context, *PulseRequest) (*PulseResponse, error) {
...
func _HeartBeat_Pulse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HeartBeat_Pulse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeartBeatServer).Pulse(ctx, req.(*PulseRequest))
	}
...
var HeartBeat_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grover.v1.HeartBeat",
